...
$layout_style = $product_item_skin = $product_tabs = $tabs_align = $columns = $columns_md = $columns_sm = $columns_xs = $columns_mb = $columns_gutter = $products_per_page = $is_slider = $rows =
    $dots = $nav = $nav_position = $nav_style = $autoplay = $autoplay_timeout = $product_paging = $product_animation = $css_animation = $animation_duration = $animation_delay = $el_class = $css = $responsive = '';

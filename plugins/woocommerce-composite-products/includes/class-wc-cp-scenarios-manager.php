...
class WC_CP_Scenarios_Manager {
	 ...
	 * @param  boolean  $validating_defaults
	 * @return boolean
	 */
	public function validate_configuration( $configuration, $validating_defaults = false ) {

		$matching_scenarios = $this->find_matching( $configuration, $validating_defaults );
	 ...
	 * @return boolean
	 */
	public function find_matching( $configuration, $validating_defaults = false ) {

		$matching_components     = array();
		$hidden_components       = array();

		$matching_scenarios      = array();
		$matching_scenarios_cg   = array();
		$matching_scenarios_cc   = array();
		$matching_scenarios_init = false;

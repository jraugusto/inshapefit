...
class WC_CP_Addons_Compatibility {
	...
	public static function component_addons_disable( $id, $data, $product_id ) {
		...
		<div class="component_selection_details_option">
			...
			<span><?php echo __( 'Disable Product Add-ons', 'woocommerce-composite-products' ); ?></span>
			<?php echo wc_help_tip( __( 'Check this option to disable any Product Add-ons associated with the selected Component Option.', 'woocommerce-composite-products' ) ); ?>
		</div>
		<?php
	}

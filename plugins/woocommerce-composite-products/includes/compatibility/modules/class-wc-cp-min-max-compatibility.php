...
class WC_CP_Min_Max_Compatibility {
	...
	public static function init() {
		...
		add_action( 'woocommerce_composite_show_composited_product', array( __CLASS__, 'restore_quantities_set' ), 29, 3 );

		// Unset global $component variable.
		add_action( 'woocommerce_composite_show_composited_product', array( __CLASS__, 'restore_quantities_unset' ), 31 );
	 ...
	 * @return void
	 */
	public static function restore_quantities_set( $product, $component_id, $composite ) {
		$product_id      = $product->get_id();
		self::$component = $composite->get_component( $component_id );
	}
	 ...
	 * @return void
	 */
	public static function restore_quantities_unset() {

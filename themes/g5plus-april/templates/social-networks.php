...
CSS;
			...
			<li class="<?php echo esc_attr($social_id)?>">
				...
				<?php else: ?>
					<a class="<?php echo esc_attr($social_class)?>" title="<?php echo esc_attr($social_name)?>" href="<?php echo esc_url($social_link)?>"><i class="<?php echo esc_attr($social_icon)?>"></i></a>
				<?php endif; ?>

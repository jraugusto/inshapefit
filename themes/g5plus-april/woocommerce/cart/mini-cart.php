...
<div class="shopping-cart-icon">
    <div class="subtotal-info-wrapper">
        <span class="total-item"><?php echo esc_html($total_item); ?> <?php esc_html_e('Items', 'g5plus-april'); ?></span> - <?php echo WC()->cart->get_cart_subtotal(); ?>
    </div>
    <div class="icon">
...
<div class="shopping-cart-list drop-shadow">
	...
	<?php if (!WC()->cart->is_empty()) : ?>
		...
		<p class="total"><strong><?php _e('Subtotal', 'g5plus-april'); ?>
